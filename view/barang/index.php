...
<div class="container"> 
  <h1><i class="fa-solid fa-user"></i>iventory akmal</h1>
                ...
                if (mysqli_num_rows($query) ) {
                    while ($result = mysqli_fetch_assoc($query)) {
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="view_edit.php?id=<?php echo $result['id_barang'] ?>" class="btn btn-warning"><i class="fa-solid fa-dragon"></i>Edit</a>
                            <a href="hapus.php?id=<?php echo $result['id_barang'] ?>" 
                            onclick="return confirm('Kamu Yakin???')" 
                            class="btn btn-danger"><i class="fa-solid fa-ban"></i>Hapus</a>
                            </td>
                        </tr>
                        <?php
                        $no++;
